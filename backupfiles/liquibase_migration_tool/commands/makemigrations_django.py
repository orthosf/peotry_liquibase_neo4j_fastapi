...
from django.apps import apps as django_apps  # Import django_apps
...
def make_migrations(migrations_dir):
    ...
    print("Historical State:", historical_state.models)  # Debug statement
    #current_state = StateApps.from_apps(apps)
    
        # Use django_apps to get the current state
    current_state = StateApps.from_apps(django_apps)
    print("Current State:", current_state.models)  # Debug statement


    autodetector = MigrationAutodetector(current_state, historical_state)
    changes = autodetector.changes()

    print("Detected Changes:", changes)  # Debug statement
